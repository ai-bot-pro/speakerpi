...
def play_audio_file(fname=os.path.join(lib.appPath.DATA_PATH, "snowboy/resources/dong.wav")):
    """
    Simple callback function to play a wave file. By default it plays a Dong sound.
